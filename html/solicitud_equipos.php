...
function validar() {
    ...
    doc.setFontSize(14);
    doc.text("SOLICITUD DE EQUIPAMIENTO Y SUMINISTROS INFORMÁTICOS", 105, 20, { align: 'center' });
    ...
    doc.autoTable({
        ...
        columnStyles: { 0: { cellWidth: 15, halign: 'center' }, 1: { cellWidth: 50 }, 2: { cellWidth: 'auto' } }
    });
