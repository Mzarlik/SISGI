    ...
    <div class="card">
        ...
        <form id="formAdquisicion">
            ...
            <div class="form-row">
                ...
                <div class="form-col">
                    <label for="imagen_equipo">Fotografía (Opcional):</label>
...
<script>
    ...
    document.getElementById('formAdquisicion').addEventListener('submit', function(e) {
        ...
        // FormData captura automáticamente los archivos seleccionados en el input type="file"
        let datos = new FormData(this);
        
        Swal.fire({ title: 'Procesando...', allowOutsideClick: false, didOpen: () => Swal.showLoading() });

        fetch('guardar_ad_equipos.php', { 
            method: 'POST', 
            body: datos 
            // NOTA: No establecer headers como 'Content-Type': 'application/json' 
            // cuando se usa FormData, el navegador define el 'multipart/form-data' automáticamente.
        })
        .then(r => r.json())
        .then(data => {
            if(data.success) {
